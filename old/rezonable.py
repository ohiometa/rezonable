...
--------------------------------------------
120 debug some common website loads
	responses like "refused" should not go forward to peers
	pmd-www.weather.com.edgekey.net. (DO THIS WITH DIG)
	CNN
	FoxNews
	Alexa
 ...
 ?? Consider how to cache empty A responses (non-referring) so we
    don't keep looking them up (leaking metadata).
...
INFINITE LOOP
-------------
  +              1  A   a.ns.xx.fbcdn.net.              pursuing A for b.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              ns avail for xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              skip over a.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              skip over b.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              skip over a.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              skip over b.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              exhausted options
  +              1  A   a.ns.xx.fbcdn.net.              pursuing A for b.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              ns avail for xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              skip over a.ns.xx.fbcdn.net.
   +             1  A   b.ns.xx.fbcdn.net.              skip over b.ns.xx.fbcdn.net.
...
def run():
	...
	g.sock = fromfd(3, AF_INET, SOCK_DGRAM)
	g.bigSock = socket(AF_INET, SOCK_DGRAM)
	g.bigSock.bind(('', outgoingPort))
	...
	while True:
		...
		ready = select([g.sock, g.bigSock], [], [], 0.1)[0]
		for sock in ready:
